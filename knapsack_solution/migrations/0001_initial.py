    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fasting_blood_sugar', models.IntegerField(choices=[(1, '> 120 mg/dl'), (0, '< 120 mg/dl')], default=0)),
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='knapsack', to='client.UserProfileInfo')),
            ],
        ),
    ]
